  ...
  return (
    <>
      {featuredProducts.map((product) => (
        <Link to={`/product/${ product.name }`} target="blank">
        <div className="w-62 shrink-0 h-37 rounded-2xl bg-white flex flex-wrap  shadow-md shadow-gray-300 p-2" >
          ...
          <div className="w-full h-[80%] flex justify-between items-center gap-2">
            ...
            <div className="w-[70%]">
              ...
              <button onClick={()=>{alert("Add to cart")}} className="flex justify-center items-center font-bebas bg-orange-500 w-[80%]  text-sm  text-white rounded-sm shadow-md shadow-black gap-2">
