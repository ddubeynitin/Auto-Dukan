...
const CartPage = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      name: "Effortless One Step Rubbing Compou...",
        ...
        <div className="w-full h-auto flex justify-center pt-5">
          <div className="w-[85%] flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 h-150 bg-white rounded-sm shadow-sm ">
                  ...
                  <div className="p-4">
                    <h2 className=" font-bebas text-lg uppercase">
                      Order Package # 1
                    </h2>
                  </div>
                  ...
                  {items.map((item) => (
                    ...
                    >
                      ...
                      <div className="col-span-1 flex justify-center">
                        <button className="text-gray-400 hover:text-red-500 border border-gray-300 p-1 rounded">
                          <FaTrash />
                        </button>
                      </div>
                    </div>
